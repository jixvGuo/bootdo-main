...
function buildScoreTableQueryParams(params, useRatingFilter) {
    ...
    // 专家打分页（主打分 + 评级）均按项目编号升序
    qp.orderByProCodeAsc = 'true';
    return qp;
}
        ...
        .bootstrapTable(
            {
                ...
                rowStyle: function (row, index) {
                    if (row.isAvoided == 1) {
                        return { css: { 'background-color': '#f8d7da' } };
                    }
                    return {};
                },
                ...
                columns: [
                    ...
                    */
                    ...
                    },
                    {
                        ...
                        align: 'center',
                        formatter: function (value, row) {
                            var d = '<a class="btn btn-primary btn-sm" href="#" onclick="onwatch(\''
    ...
    $('#ratingTable').bootstrapTable({
        ...
        columns: [
            ...
            // },
            {
                ...
                align: 'center',
                formatter: function (value, row) {
                    return '<a class="btn btn-primary btn-sm" href="#" onclick="onwatch(\''
