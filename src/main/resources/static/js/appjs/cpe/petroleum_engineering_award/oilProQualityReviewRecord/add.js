...
function save() {
	...
	$.ajax({
		cache : true,
		type : "POST",
		url : "/petroleum_engineering_award/oilProQualityReviewRecord/save",
		...
		success : function(data) {
			if (data.code == 0) {
				...
				let iframeSrc = $("iframe[data-id='/petroleumEngineering/toQualityList']",parent.document).attr('src');
				$("iframe[data-id='/petroleumEngineering/toQualityList']",parent.document).attr('src', iframeSrc);
