...
function save() {
    ...
    $.ajax({
        cache: true,
        type: "POST",
        url: "/petroleum_engineering_award/oilProInstallReviewRecord/save",
        ...
        success: function (data) {
            if (data.code == 0) {
                ...
                let iframeSrc = $("iframe[data-id='/petroleumEngineering/toInstallList']",parent.document).attr('src');
                $("iframe[data-id='/petroleumEngineering/toInstallList']",parent.document).attr('src', iframeSrc);
