        ...
        .bootstrapTable(
            {
                ...
                url: prefix + "/getViewQualityCheckResultList", // 服务器数据的加载地址
                //	showRefresh : true,
                //	showToggle : true,
                //	showColumns : true,
                iconSize: 'outline',
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        align: 'center',
                        formatter: function (value, row, index) {
                            var v = '<a class="btn btn-primary" href="javascript:page(\'/enterpriseQualityAward/toReview?reviewId='+row.id+'&proId='+ row.proId + '&readonly=1\',\'审查结果\',\'' + 202102 + '\')" mce_href="#" title="查看">查看</a> ';
                            return v;
                        }
                    }]
            });
