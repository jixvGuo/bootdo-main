                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        formatter: function (value, row, index) {
                            ...
                            var v = '<a class="btn btn-primary" href="javascript:page(\'/enterpriseQualityGoldAward/toEditApply?id=' + row.applyInfoId + '&proId=' + row.proId + '&readonly=1\',\'' + row.proName + '\',\'' + 202101 + '\',' + s_parent_view + ')" mce_href="#" title="查看">查看</a> ';
                            var review = '<a class="btn btn-primary ' + rs_review_h + '" href="javascript:page(\'/enterpriseQualityGoldAward/toReview?applyInfoId=' + row.applyInfoId + '&proId=' + row.proId + '\',\'' + row.proName + '\',\'' + 202101 + '\')" mce_href="#" title="审核">审核</a> ';
                            var e = '<a class="btn btn-primary ' + rs_edit_h + '" href="javascript:page(\'/enterpriseQualityGoldAward/toEditApply?id=' + row.applyInfoId + '&proId=' + row.proId + '\',\'' + row.proName + '\',\'' + 202101 + '\')" mce_href="#" title="修改">修改</a> ';
                            var f = '<a class="btn btn-success ' + rs_remove_h + '" href="#" title="删除"  mce_href="#" onclick="remove(\''
                                + row.proId
                                + '\')"> 删除</a> ';

                            var g = '<a class="btn btn-success ' + rs_print_h + '" href="/enterpriseQualityGoldAward/toPrintGoldFile?id=' + row.applyInfoId + '&proId=' + row.proId + '" title="打印"  mce_href="#">打印 </a> ';
                            ...
                            var reviewResult = '<a class="btn btn-primary ' + rs_review_result_h + '" href="javascript:page(\'/petroleumEngineering/viewQualityGoldCheckResultList?id=' + row.applyInfoId + '&proId=' + row.proId + '&readonly=1\',\'' + row.proName + '\',\'' + 202102 + '\')" mce_href="#" title="审查结果">审查结果</a> ';
