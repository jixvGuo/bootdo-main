        ...
        .bootstrapTable(
            {
                ...
                url: prefix + "/installList", // 服务器数据的加载地址
                //	showRefresh : true,
                //	showToggle : true,
                //	showColumns : true,
                iconSize: 'outline',
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        formatter: function (value, row, index) {
                            ...
                            var v = '<a class="btn btn-primary" href="javascript:page(\'/enterpriseUnitApply/toEngineeDescEdit?id=' + row.situationId + '&proId=' + row.proId + '&readonly=1\',\'' + row.proName + '\',\'' + 202101 + '\',' + s_parent_view + ')" mce_href="#" title="查看">查看</a> ';
                            ...
                            var e = '<a class="btn btn-primary ' + rs_edit_h + '" href="javascript:page(\'/enterpriseUnitApply/toEngineeDescEdit?id=' + row.situationId + '&proId=' + row.proId + '\',\'' + row.proName + '\',\'' + 202101 + '\')" mce_href="#" title="修改">修改</a> ';
                            var f = '<a class="btn btn-success ' + rs_remove_h + '" href="#" title="删除"  mce_href="#" onclick="remove(\''
                                + row.proId
                                + '\')"> 删除</a> ';

                            var g = '<a class="btn btn-success ' + rs_print_h + '" href="/enterpriseUnitApply/toPrint?id=' + row.companyId + '&proId=' + row.proId + '" title="打印"  mce_href="#">打印 </a> ';
