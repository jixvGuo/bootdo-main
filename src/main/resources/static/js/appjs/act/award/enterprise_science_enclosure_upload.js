...
$().ready(function () {
    ...
    var scienceArr = rstScienceValiFile ? rstScienceValiFile.split(",") : [];
    ...
    var tuanduiArr = rstTuanduiValiFile ? rstTuanduiValiFile.split(",") : [];
    ...
    var personalArr = rstPersonalValiFile ? rstPersonalValiFile.split(",") : [];
