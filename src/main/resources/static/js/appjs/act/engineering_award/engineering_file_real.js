...
$().ready(function () {
    ...
    $(".btn-block").click(function (event) {
        ...
        let inputFileType = $(this).attr("filetype");
        fileType = fileType + "-" + inputFileType;
        console.log("------->fileType=", fileType, inputFileType);
        layer.open({
            title: '上传文件',
            maxmin: true,
            type: 2,
            ...
            area: ['800px', '520px'],
            content: '/enterpriseQualityAward/toUploadConfirmDialog?taskId='+taskId+'&proId=' + proId + "&fileType="+fileType // iframe的url
        });
