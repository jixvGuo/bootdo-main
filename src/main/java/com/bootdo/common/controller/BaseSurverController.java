 ...
 * @author houzb
 * @version 1.0
 * @date 2022-03-23 07:29
 */
@Controller
public class BaseSurverController extends BaseController {
    ...
    public boolean isTaskIsApply(ModelMap map, Map<String, Object> params) {
        ...
        PublishAwardTaskDo awardTaskDo = awardPublishTaskService.getLastProTaskByAwardType(EnumAwardType.SURVER.getAwrdType() + "");
        if (awardTaskDo == null) {
            isApply = false;
    ...
    public void packageAwardTaskId(ModelMap map, Map<String, Object> params) {
        ...
        if(paramsTaskIdObj == null) {
            PublishAwardTaskDo taskDo = awardPublishTaskService.getLastProTaskByAwardType(EnumAwardType.SURVER.getAwrdType() + "");
    ...
    public Map<String, Object> getProListParamsByRole(Map<String, Object> params) {
        ...
        for (long rid : roleIds) {
            if (rid == ROLE_ADMIN_ID) {
                ...
                break;
            } else if (rid == ROLE_ENTERPRISE_SURVER_ID) {
                //企业用户
