...
//        taskService.complete(taskId, vars);
    ...
    public String startProcess(String procDefKey, String businessTable, String businessId, String title, Map<String, Object> vars) {
        ...
        return startProcessByUid(userId,procDefKey,businessTable,businessId,title,vars);
    }

    @Override
    public String startProcessByUid(String startUid, String procDefKey, String businessTable, String businessId, String title, Map<String, Object> vars) {
        // 用来设置启动流程的人员ID，引擎会自动把用户ID保存到activiti:initiator中
        identityService.setAuthenticatedUserId(startUid);
