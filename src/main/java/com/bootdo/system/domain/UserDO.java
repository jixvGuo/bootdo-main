...
public class UserDO implements Serializable {
    ...
    //
//  `` varchar(45) DEFAULT NULL COMMENT '专家姓名',
//            `` varchar(45) DEFAULT NULL COMMENT '公司名称',
//            `` int(11) DEFAULT NULL COMMENT '卡号',
