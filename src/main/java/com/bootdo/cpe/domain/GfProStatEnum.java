...
public enum GfProStatEnum {
    ...
    GfProStatEnum(String proStat, String statDesc, boolean isEdit, boolean isReview, boolean isCancelReview, boolean isReviewResult, boolean isDownloadProDoc) {
    ...
    public static List<String> getStatValByKey(String key) {
          ...
          for(GfProStatEnum stat: GfProStatEnum.values()) {
