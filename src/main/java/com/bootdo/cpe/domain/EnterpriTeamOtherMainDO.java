 ...
 */
public class EnterpriTeamOtherMainDO implements Serializable {
    ...
    private List<QCImageObj> educationundergoImage = new ArrayList<>();
    ...
    public void setSerialnumber(String serialnumber) {
        if(StringUtils.isNotBlank(serialnumber) && StringUtils.isNumeric(serialnumber.trim())) {
            this.serialnumberInt = Integer.parseInt(serialnumber.trim());
        }else {
            this.serialnumberInt = -1;
        }
    ...
    public void setEducationundergo(String educationundergo) {
        ...
        //this.educationundergoImage = CpeCommonUtils.getImages(this.educationundergo,bootdoConfig.getImgUrlPre());
    ...
    public List<QCImageObj> getEducationundergoImage() {
        return educationundergoImage;
    }

    public void setEducationundergoImage(List<QCImageObj> educationundergoImage) {
        this.educationundergoImage = educationundergoImage;
    }
