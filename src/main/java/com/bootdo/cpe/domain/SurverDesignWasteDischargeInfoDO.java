 ...
 */
public class SurverDesignWasteDischargeInfoDO implements Serializable {
	...
	//国家允许排放指标
	private String innerAllowDischargeLevel;
	//备注
	private String memo;
	//操作用户id
	 ...
	 * 设置：国家允许排放指标
	 */
	public void setInnerAllowDischargeLevel(String innerAllowDischargeLevel) {
		this.innerAllowDischargeLevel = innerAllowDischargeLevel;
	}
	/**
	 * 获取：国家允许排放指标
	 */
	public String getInnerAllowDischargeLevel() {
		return innerAllowDischargeLevel;
	}
	/**
	 * 设置：备注
	 */
