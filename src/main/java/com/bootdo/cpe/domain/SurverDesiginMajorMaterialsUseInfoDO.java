 ...
 */
public class SurverDesiginMajorMaterialsUseInfoDO implements Serializable {
	...
	//国际先进水平
	private String outerAdvancedLevel;
	//备注
	private String memo;
	//操作用户id
	 ...
	 * 设置：国际先进水平
	 */
	public void setOuterAdvancedLevel(String outerAdvancedLevel) {
		this.outerAdvancedLevel = outerAdvancedLevel;
	}
	/**
	 * 获取：国际先进水平
	 */
	public String getOuterAdvancedLevel() {
		return outerAdvancedLevel;
	}
	/**
	 * 设置：备注
	 */
