 ...
 */
public class OilAwardPartakeUnitDO implements Serializable {
	private static final long serialVersionUID = 1L;
	
	//
	private Integer id;
	// 单位名称及完成产值（百分率）
	private String unitOutputValue;
	//通讯地址及邮政编码
	 ...
	 * 设置： 单位名称及完成产值（百分率）
	 */
	public void setUnitOutputValue(String unitOutputValue) {
		this.unitOutputValue = unitOutputValue;
	}
	/**
	 * 获取： 单位名称及完成产值（百分率）
	 */
	public String getUnitOutputValue() {
		return unitOutputValue;
	}
	/**
	 * 设置：通讯地址及邮政编码
	 */
