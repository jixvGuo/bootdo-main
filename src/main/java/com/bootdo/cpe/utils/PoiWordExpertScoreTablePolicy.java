...
public class PoiWordExpertScoreTablePolicy  extends DynamicTableRenderPolicy {
    ...
    public void render(XWPFTable table, Object data) throws Exception {
        ...
        for (int i = 0; i < situationDO.size(); i++) {
            ...
            RowRenderData awardUnitRow = Rows.of(award.getShowNum(), award.getChengguo(),award.getTechnologyAdvancement(),
                    award.getDegreeInnovation(),award.getDifficultyComplex(),award.getLoreProperty(),award.getEconomicBenefit(),
                    award.getSocialBenefit(),award.getPromotionProspect(),award.getPreparationExpression(),award.getTotal(),award.getLevel()).textFontFamily("Arial Unicode MS").textFontSize(12).create();
