...
//            "石油工程建设优秀勘察奖",
            "石油工程建设优秀勘察",
            new String[]{"excellent_scanned_copy","excellent_accessory_material_report","excellent_accessory_material_pic","excellent_upload_accessories_catalog",
    "excellent_project_profile_sheet"},
            new String[]{"excellent_materials_construction_unit","excellent_materials_construction_unit_acceptance_certificate",
...
//            "石油工程建设优秀设计奖",
            "石油工程建设优秀设计",
            new String[]{"appendix_file_design","appendix_file_pic"},
...
//            "石油工程建设优秀勘察设计计算机软件奖",
            "石油工程建设优秀勘察设计计算机软件",
            new String[]{"apply_table","manual_book","soft_upload_accessories_catalog",
    "soft_project_profile_sheet"},
            new String[]{"iden_cert","user_report","economics","award_cert","first_reprot"}),
    STANDARD("standard",
//            "石油工程建设优秀标准设计奖",
            "石油工程建设优秀标准设计",
            new String[]{"apply_table","standard_desc","publish_txt","standard_upload_accessories_catalog",
    "standard_project_profile_sheet"},
            new String[]{"use_desc","economics_cert", "bureau_level_award"}),
    CONSULTING("consulting",
            "石油工程建设优秀咨询奖",
            new String[]{"apply_table","result_report",
    "recommend_cret", "appendix_imgs", "appendix_imgs_pic"},
            new String[]{"pro_proposal","topic_report","study_report",
